    ...
    <div className="min-h-screen flex items-center justify-center bg-[var(--bg-app)] p-4">
      <Card className="w-full max-w-md bg-[var(--bg-card)] border-[var(--border-subtle)] shadow-sm">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-[var(--text-primary)]">Theme preview not found</CardTitle>
          <CardDescription className="text-[var(--text-muted)]">
            The theme preview page doesn't exist
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <p className="text-sm text-[var(--text-muted)] text-center">
            The theme preview page you're trying to access could not be found. 
